...
public class EVChargingStationManager {
    ...
    private static void userLoginOrRegister() {
        ...
        int option = readIntegerInput("Choose an option: ");
    ...
    private static void bookChargingSlot() {
        ...
        int slotNumber = readIntegerInput("Enter Slot Number: ");
        int duration = readIntegerInput("Enter Duration (hours): ");
    ...
    private static void displayUsersCurrentBookings() {
        ...
        for (ChargingStation station : stations) {
            for (ChargingSlot slot : station.getSlots()) {
                if (!slot.isAvailable() &&
                        slot.getBookedBy().equals(currentUser)) {

                    hasBookings = true;

                    double cost = station.calculateCost(
